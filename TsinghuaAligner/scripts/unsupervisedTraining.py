...
root_dir = '/home/znn/data/aligner/TsiinghuaAliger/TsinghuaAligner'
...
if __name__ == '__main__':
	...
	srcFileName = ''             # source file name源文件名字
	trgFileName = ''             # target file name目标文件名字
	srcVcbFileName = ''          # source vocabulary file name源文件词表文件
	trgVcbFileName = ''          # target vocabulary file name目标文件词表文件
	s2tTTableFileName = ''       # source-to-target TTable file name源-目标映射文件
	t2sTTableFileName = ''       # target-to-source TTable file name目标-源映射文件
	trainingCorpusSize = 10      # training corpus size# 训练数据集条数
	sentLengthLimit = 100        # sentence length limit of training corpus# 训练数据集限制句子的单词个数

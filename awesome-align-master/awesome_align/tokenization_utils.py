...
class PreTrainedTokenizer(object):
    ...
    def from_pretrained(cls, *inputs, **kwargs):
        ...
        Examples::
            ...
            # If vocabulary files are in a directory (e.g. tokenizer was saved using `save_pretrained('./model_data/saved_model/')`)
            tokenizer = BertTokenizer.from_pretrained('./model_data/saved_model/')

            # If the tokenizer uses a single vocabulary file, you can point directly to this file
            tokenizer = BertTokenizer.from_pretrained('./model_data/saved_model/my_vocab.txt')

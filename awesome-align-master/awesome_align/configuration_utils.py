...
class PretrainedConfig(object):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs) -> "PretrainedConfig":
        ...
        Examples::
            ...
            config = BertConfig.from_pretrained('./model_data/saved_model/')  # E.g. config (or model) was saved using `save_pretrained('./model_data/saved_model/')`
            config = BertConfig.from_pretrained('./model_data/saved_model/my_configuration.json')

...
def main():
    ...
    # Required parameters
    parser.add_argument(
        "--data_file", default=os.path.join(base_dir, "../data/model_data/test.txt"), type=str,
        help="The input data file (a text file)."
    )
    parser.add_argument(
        "--output_file",
        type=str,
        default=os.path.join(base_dir, "../align_output/align_result.txt"),
    ...
    parser.add_argument(
        "--output_prob_file", default=os.path.join(base_dir, "../align_output/output_prob_file.txt"), type=str, help='The output probability file.'
    )
    parser.add_argument(
        "--output_word_file", default=os.path.join(base_dir, "../align_output/output_word_file.txt"), type=str, help='The output word file.'
    )
    parser.add_argument(
        "--model_name_or_path",
        default="bert-base-multilingual-cased",
        # default=os.path.join(base_dir, "../outputs","checkpoint-30000"),
        type=str,
    ...
    parser.add_argument(
        "--config_name",
        default="bert-base-multilingual-cased",
        # default=os.path.join(base_dir, "../outputs","checkpoint-30000","config.json"),
        type=str,
    ...
    parser.add_argument(
        "--tokenizer_name",
        default="bert-base-multilingual-cased",
        # default=os.path.join(base_dir, "../outputs","checkpoint-30000","tokenizer_config.json"),
        type=str,
